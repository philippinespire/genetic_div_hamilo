...
model_inf_3change_temporal.add_leaf("AHam",N="n_cont",t=109)
...
for i in range(n_bootstraps):
	...
	model_inf_3change_copy.set_data(resampled_sfs, length=485532)
...
boot="/home/rdclark/PIRE/leiognathus_leuciscus/momi2/Ela_temp3change_bootstraps.csv" 
f = open(boot,"a") 
f.write("n_hist") 
